...
they ask specifically for one question. Question one is very simple and it only asks
...
The question is not very clear and objective. But to make matters worse, this man frightened readers with 
his huge code. Even if a person is willing to help, that person will lose interest in answering the question.
Question two is very common. The question is not objective also, but it is not the reason I decided to talk 
about it. That person clearly wants others to do his homework. He is not asking for help, he is demanding, 
and he puts all the steps in order (1, 2, 3). He also wants people to format the code by using coding style.
But what if someone decides to help him? He does not provide any information either.
